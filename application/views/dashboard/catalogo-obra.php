    ...
    <div id="page-wrapper">
        ...
        <div class="row">
            ...
            <div class="col-lg-3 col-md-4 col-xs-6 thumb"> 
                <a class="thumbnail" href="<?php echo base_url($url)?>?cod=<?php echo $catalogo->idEbook  ?>">
                    <img class="img-responsive" src="<?php echo $catalogo->Capa ?>">
                </a>
                <h3>
                    <a href="<?php echo base_url($url)?>?cod=<?php echo $catalogo->idEbook  ?>"><?php echo $catalogo->Titulo_Ebook  ?></a>
                </h3>
